...
export interface ApiOrderDetailOrderDetail extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    broker_fee: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    delivery_charge: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    selling_price: Schema.Attribute.String;
    total_amount: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiOrderMenuOrderMenu extends Struct.CollectionTypeSchema {
  collectionName: 'order_menus';
  info: {
    displayName: 'Order_menu';
    pluralName: 'order-menus';
    singularName: 'order-menu';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    additional_dish: Schema.Attribute.String;
    box: Schema.Attribute.String;
    chip: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    fruit: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    order_id: Schema.Attribute.Relation<'manyToMany', 'api::order.order'>;
    publishedAt: Schema.Attribute.DateTime;
    pudding: Schema.Attribute.String;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    vegetable: Schema.Attribute.String;
  };
}
...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    arrive_time: Schema.Attribute.String;
    ...
    order_details: Schema.Attribute.Relation<
      ...
      'api::order-detail.order-detail'
    >;
    order_menus: Schema.Attribute.Relation<
      'manyToMany',
      'api::order-menu.order-menu'
    >;
...
export interface ApiStaffStaff extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    name: Schema.Attribute.String;
    orders: Schema.Attribute.Relation<'oneToMany', 'api::order.order'>;
    orders_driver: Schema.Attribute.Relation<'oneToMany', 'api::order.order'>;
    position: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    staff_status: Schema.Attribute.Enumeration<
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    user_role: Schema.Attribute.Enumeration<['staff', 'customer']> &
